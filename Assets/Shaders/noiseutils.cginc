...
float fbm(float2 st, int octaves, float lacunarity, float gain){
    float amp = .5;
    float val = 0;
...
float turbulance(float2 st, int octaves, float lacunarity, float gain){
    float amp = .5;
    float val = 0;
...
float ridge(float2 st, int octaves, float lacunarity, float gain){
    float amp = .5;
    float val = 0;
